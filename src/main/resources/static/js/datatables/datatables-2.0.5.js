...
!function (n) {
    ...
    var C, U, e, t, $ = function (t, H) {
            ...
            return $.factory(t, H) ? $ : this instanceof $ ? V(t).DataTable(H) : (X = void 0 === (H = t), B = (W = this).length, X && (H = {}), this.api = function () {
                ...
                if ("table" != this.nodeName.toLowerCase()) Z(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2); else {
                    ...
                    var g, m, v, b, y, D, x, S = u, w = n.aoColumnDefs, T = f, M = p, _ = function (t, e) {
                        ot(u, t, e)
                    }, C = S.aoColumns;
                    if (T) for (g = 0, m = T.length; g < m; g++) T[g] && T[g].name && (C[g].sName = T[g].name);
                    if (w) for (g = w.length - 1; 0 <= g; g--) {
    ...
    function S(t, e) {
        if (r = "ssp" == et(s = t), void 0 !== (i = s.iInitDisplayStart) && -1 !== i && (s._iDisplayStart = !r && i >= s.fnRecordsDisplay() ? 0 : i, s.iInitDisplayStart = -1), -1 !== tt(t, "aoPreDrawCallback", "preDraw", [t]).indexOf(!1)) T(t, !1); else {
            var l, n = [], a = 0, r = "ssp" == et(t), o = t.aiDisplay, i = t._iDisplayStart, s = t.fnDisplayEnd(),
                u = t.aoColumns, c = V(t.nTBody);
            if (t.bDrawing = !0, r) {
                if (!t.bDestroying && !e) return 0 === t.iDraw && c.empty().append(wt(t)), (l = t).iDraw++, T(l, !0), void At(l, function (e) {
                    function n(t, e) {
                    ...
                    e.aiDisplay = e.aiDisplayMaster.slice(), S(e, !0), kt(e), T(e, !1)
                })
            } else t.iDraw++;
    ...
    function Ct(e) {
        ...
        if (e.nTableWrapper = r[0], e.sDom) for (var o, i, l, s, u, c, d = e, t = e.sDom, f = r, h = t.match(/(".*?")|('.*?')|./g), p = 0; p < h.length; p++) o = null, "<" == (i = h[p]) ? (l = V("<div/>"), "'" != (s = h[p + 1])[0] && '"' != s[0] || (s = s.replace(/['"]/g, ""), u = "", -1 != s.indexOf(".") ? (c = s.split("."), u = c[0], c = c[1]) : "#" == s[0] ? u = s : c = s, l.attr("id", u.substring(1)).addClass(c), p++), f.append(l), f = l) : ">" == i ? f = f.parent() : "t" == i ? o = Wt(d) : $.ext.feature.forEach(function (t) {
            ...
            var n = Tt(e, e.layout, "top"), t = Tt(e, e.layout, "bottom"), g = te(e, "layout");
        ...
        n.oFeatures.bProcessing && (a = V("<div/>", {
            ...
            role: "status"
        }).html(n.oLanguage.sProcessing).append("<div><div></div><div></div><div></div><div></div></div>").insertBefore(t), V(t).on("processing.dt.DT", function (t, e, n) {
    ...
    function At(n, t, a) {
        ...
        var r, o = n.ajax, i = n.oInstance,
            l = (V.isPlainObject(o) && o.data && (l = "function" == typeof (r = o.data) ? r(t, n) : r, t = "function" == typeof r && l ? l : V.extend(!0, t, l), delete o.data), {
                ...
                error: function (t, e) {
                    -1 === tt(n, null, "xhr", [n, null, n.jqXHR], !0).indexOf(!0) && ("parsererror" == e ? Z(n, 0, "Invalid JSON response", 1) : 4 === t.readyState && Z(n, 0, "Ajax error", 7)), T(n, !1)
                }
            });
    ...
    function Nt(n, t) {
        ...
        if (B(n), "ssp" != et(n)) {
            ...
            for (var p, g, m = n, v = $.ext.search, b = m.aiDisplay, y = 0, D = v.length; y < D; y++) {
                for (var x = [], S = 0, w = b.length; S < w; S++) g = b[S], p = m.aoData[g], v[y](m, p._aFilterData, g, p._aData, S) && x.push(g);
    ...
    function jt(t, e, n, a, r) {
        if ("" !== n) for (var o = 0, i = "function" == typeof n ? n : null, l = n instanceof RegExp ? n : i ? null : function (t, e) {
            ...
            var s = e.aoData[t[o]], u = void 0 === r ? s._sFilterRow : s._aFilterData[r];
            (i && !i(u, s._aData, t[o], r) || l && !l.test(u)) && (t.splice(o, 1), o--), o++
        }
    }
    ...
    function Xt(e) {
        ...
        if (e.scrollBarVis !== f && void 0 !== e.scrollBarVis) e.scrollBarVis = f, M(e); else {
            if (e.scrollBarVis = f, u.children("thead, tfoot").remove(), (f = s.clone().prependTo(u)).find("th, td").removeAttr("tabindex"), f.find("[id]").removeAttr("id"), c && (m = c.clone().prependTo(u)).find("[id]").removeAttr("id"), e.aiDisplay.length) for (var h = u.find("tbody tr").eq(0).find("th, td").map(function (t) {
    ...
    function re(r, o, t) {
        ...
        t && (e = new U(r)).one("draw", function () {
            t(e.ajax.json())
        }), "ssp" == et(r) ? s(r, o) : (T(r, !0), (n = r.jqXHR) && 4 !== n.readyState && n.abort(), At(r, {}, function (t) {
            pt(r);
    ...
    var he = function (t, e) {
        var n, a = [], r = t.aiDisplay, o = t.aiDisplayMaster, i = e.search, l = e.order;
        if ("current" == e.page) for (u = t._iDisplayStart, c = t.fnDisplayEnd(); u < c; u++) a.push(r[u]); else if ("current" == l || "applied" == l) {
            ...
            return e = n, l = a, s = (i = t).aoColumns, u = f(s, "sName"), c = f(s, "sTitle"), t = $.util.get("[].[].cell")(i.aoHeader), d = x(E([], t)), oe("column", e, function (n) {
                ...
                if (r) switch (r[2]) {
                    ...
                    case"visible":
                        ...
                        return o < 0 ? [(e = s.map(function (t, e) {
        ...
        var n;
        if (0 !== this.context.length) return n = this.context[0], "fromVisible" === t || "toData" === t ? H(n, e) : "fromData" === t || "toVisible" === t ? w(n, e) : void 0
    ...
    }), $.version = "2.0.5", $.settings = [], $.models = {}, $.models.oSearch = {
        caseInsensitive: !0,
        search: "",
        regex: !1,
        smart: !0,
    ...
    function Te(s) {
        return function (a, r, o, i) {
            ...
            return $.ext.type.order[l] || $.type(l, {
                ...
                var n;
                return null == t && (t = "--now" === i ? (n = new Date, new Date(Date.UTC(n.getFullYear(), n.getMonth(), n.getDate(), n.getHours(), n.getMinutes(), n.getSeconds()))) : ""), "type" === e ? l : "" === t ? "sort" !== e ? "" : we("0000-01-01 00:00:00", null, o) : !(null === r || a !== r || "sort" === e || "type" === e || t instanceof Date) || null === (n = we(t, a, o)) ? t : "sort" === e ? n : (t = null === r ? xe(n, "toDate", "toJSDate", "")[s]() : xe(n, "format", "toFormat", "toISOString", r), "display" === e ? u(t) : t)
            }
        }
    }
