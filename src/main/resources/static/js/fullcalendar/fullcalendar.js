...
var FullCalendar = function (e) {
    ...
    class qn extends Gn {
        constructor() {
            super(...arguments), this.id = Ze(), this.queuedDomNodes = [], this.currentDomNodes = [], this.handleEl = e => {
                const {options: t} = this.context, {generatorName: n} = this.props;
    ...
    class El extends ls {
        ...
        render() {
            let {props: e, state: t, context: n} = this, {options: r} = n, i = e.cells.length,
                s = rl(e.businessHourSegs, i), o = rl(e.bgEventSegs, i), a = rl(this.getHighlightSegs(), i),
                l = rl(this.getMirrorSegs(), i), {
                    singleColPlacements: c,
                    multiColPlacements: d,
                    moreCnts: u,
                    moreMarginTops: h
                } = vl(di(e.fgEventSegs, r.eventOrder), e.dayMaxEvents, e.dayMaxEventRows, r.eventOrderStrict, t.segHeights, t.maxContentHeight, e.cells),
    ...
    class Sl extends ls {
        ...
        render() {
            ...
            return p(Rs, {unit: "day"}, (t, d) => p(y, null, e.cells.map((t, u) => p(El, {
    ...
    class Dl extends ls {
        ...
        render() {
            ...
            }, e.colGroupNode, p("tbody", {role: "presentation"}, p(Sl, {
                dateProfile: e.dateProfile,
                cells: e.cells,
    ...
    class Cl extends ls {
        ...
        render() {
            let {props: e, context: t} = this;
            return p(Dl, Object.assign({ref: this.tableRef}, this.slicer.sliceProps(e, e.dateProfile, e.nextDayThreshold, t, e.dayTableModel), {
                dateProfile: e.dateProfile,
    ...
    class Sc extends ls {
        ...
        render() {
            ...
            return p("div", {
                ...
                style: {height: i ? "" : l},
                role: "presentation"
            }, p("tbody", {role: "rowgroup"}, p(Sl, Object.assign({}, a, {
                dateProfile: r,
                cells: o.cells,
                eventSelection: e.eventSelection,
                dayMaxEvents: !i,
    ...
    var _c = Po({
        name: "@fullcalendar/multimonth", initialView: "multiMonthYear", optionRefiners: xc, views: {
            multiMonth: {
                ...
                }, dateProfileGeneratorClass: xl, multiMonthMinWidth: 350, multiMonthMaxColumns: 3
    ...
    }, e.version = "6.1.11", Object.defineProperty(e, "__esModule", {value: !0}), e
}({});