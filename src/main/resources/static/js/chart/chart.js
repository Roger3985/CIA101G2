...
!function (t, e) {
    ...
    class Js extends Hs {
        ...
        _computeGridLineItems(t) {
            const e = this.axis, i = this.chart, s = this.options, {grid: n, position: a, border: r} = s, h = n.offset,
                ...
                g = r.setContext(this.getContext()), p = g.display ? g.width : 0, m = p / 2, x = function (t) {
                    return Ae(i, t, p)
                };
        ...
        _computeLabelItems(t) {
            const e = this.axis, i = this.options, {position: s, ticks: a} = i, r = this.isHorizontal(),
                ...
                p = u ? -d : g, m = -$(this.labelRotation), x = [];
    ...
    class xn {
        ...
        resolveNamedOptions(t, e, i, s = [""]) {
            const o = {$shared: !0}, {resolver: a, subPrefixes: r} = bn(this._resolverCache, t, s);
            let l = a;
            if (function (t, e) {
    ...
    class An {
        ...
        render() {
            !1 !== this.notifyPlugins("beforeRender", {cancelable: !0}) && (bt.has(this) ? this.attached && !bt.running(this) && bt.start(this) : (this.draw(), wn({chart: this})))
        }
                ...
                l = this._getRingWeight(this.index), {
                    ...
                    if (e < O) {
                        const r = t, l = r + e, h = Math.cos(r), c = Math.sin(r), d = Math.cos(l), u = Math.sin(l),
                            ...
                            m = f(E, c, u), x = g(C, h, d), b = g(C + E, c, u);
                        s = (p - x) / 2, n = (m - b) / 2, o = -(p + x) / 2, a = -(m + b) / 2
                    }
                    return {ratioX: s, ratioY: n, offsetX: o, offsetY: a}
                }(u, d, r), x = (i.width - o) / f, b = (i.height - o) / g, _ = Math.max(Math.min(x, b) / 2, 0),
    ...
    function qn(t, e, i, s, n, o) {
        ...
        const p = (g - Math.max(.001, g * d - i / C) / d) / 2, m = l + p + f, x = n - p - f, {
                ...
                innerStart: y,
                innerEnd: v
            } = Un(e, u, d, x - m), M = d - b, w = d - _, k = m + b / M, S = x - _ / w, P = u + y, D = u + v, O = m + y / P,
            A = x - v / D;
        if (t.beginPath(), o) {
            const e = (k + S) / 2;
        ...
        buildTicks() {
            ...
            const n = function (t, e) {
                const i = [], {
                        ...
                        maxDigits: d,
                        includeBounds: u
                    } = t, f = o || 1, g = c - 1, {min: p, max: m} = e, x = !s(a), b = !s(r), _ = !s(h),
                    y = (m - p) / (d + 1);
                ...
                let D = 0;
                for (x && (u && M !== a ? (i.push({value: a}), M < a && D++, V(Math.round((M + D * S) * v) / v, a, mo(a, y, t)) && D++) : M < a && D++); D < k; ++D) {
                    const t = Math.round((M + D * S) * v) / v;
                    if (b && t > r) break;
                    i.push({value: t})
                }
                return b && u && w !== r ? i.length && V(i[i.length - 1].value, r, mo(r, y, t)) ? i[i.length - 1].value = r : i.push({value: r}) : b && w !== r || i.push({value: w}), i
            }({
                maxTicks: i,
                bounds: t.bounds,
                min: t.min,
    ...
    class ba extends Hs {
        ...
        _draw() {
            ...
            const {boxWidth: g, boxHeight: p, itemHeight: m} = xa(o, d), x = this.isHorizontal(),
