(function (e) {
    ...
    var a = function (h, t, o) {
        ...
        var l = '<div class="minutes"><span class="count">' + h.minutes + '</span><span class="title">' + (h.minutes > 1 ? t.regional.minutes : t.regional.minute) + "</span></div>";
        var p = '<div class="seconds"><span class="count">' + h.seconds + '</span><span class="title">' + (h.seconds > 1 ? t.regional.seconds : t.regional.second) + "</span></div>";
        var s = false
            , q = false
            , j = false
            , g = false
