...
@Controller
@ResponseBody
public class GoogleOAuthControllerByAlreadyLogin {
    ...
    @GetMapping("/google/buildAuthUrlByAlreadyLogin")
    public String buildAuthUrl() {
        ...
        UriComponentsBuilder uriBuilder = UriComponentsBuilder
                ...
                .queryParam("redirect_uri", "http://localhost:8080/frontend/member/memberData")
    ...
    @PostMapping(value = "/google/exchangeTokenByAlreadyLogin")
    public String exchangeToken(@RequestBody ExchangeTokenRequest exchangeTokenRequest,
        ...
        body.add("redirect_uri", "http://localhost:8080/frontend/member/memberData");
    ...
    @PostMapping("/google/getGoogleUserByAlreadyLogin")
...
//    }
    ...
    @PostMapping("/google/refreshTokenByAlreadyLogin")
