...
import com.howard.rentalorder.service.RentalOrderShippingService;
...
@Component
public class RentalOrderShippingServiceImpl implements RentalOrderShippingService {
    ...
    public String shipping(Integer rentalOrdNo) {
        ...
        obj.setSenderName( "howard" ); // 寄件人姓名
...
//        obj.setReceiverCellPhone("0923561207"); // 收件人手機號碼
        obj.setReceiverCellPhone( rentalOrder.getrentalRcvPhone() ); // 收件人手機號碼
//        obj.setReceiverAddress("32041桃園市中壢區復興路46號8樓"); // 收件人地址
        obj.setReceiverAddress( rentalOrder.getrentalAddr() ); // 收件人地址
...
//        obj.setClientReplyURL( "http://localhost:8080/backend/rentalorder/testToRentalCart" );
        ...
        logisticsStateServiceImpl.setLogisticsState(rentalOrder, formHTML);
