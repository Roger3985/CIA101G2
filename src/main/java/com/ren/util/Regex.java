...
public interface Regex {
    ...
    Pattern resourcesRegex =
            Pattern.compile(".*\\.(css|js|png|jpg|jpeg|gif|svg|woff|ttf|woff2)$|/register|/login|/forgotPassword|/sendEmail|/signUp");
