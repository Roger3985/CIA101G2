...
## Start with
* 環境需求: Java 17 ([download](https://www.oracle.com/java/technologies/javase/jdk17-archive-downloads.html))、Redis ([download](https://redis.io/downloads/))、RabbitMQ([安裝方式請看我](https://github.com/Roger3985/CIA101G2/blob/master/RABBITMQ_SETTING.md))
